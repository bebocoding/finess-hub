...
class FlexibilityAssessment(OPTPhaseAssessment):
    ...
    def calculate_score(self):
        ...
        flexibility_score = (sit_and_reach * 0.4) + \
            (shoulder_mobility * 0.3) + (trunk_rotation * 0.3)
    ...
    def run_assessment(self):
        ...
        trunk_rotation = float(
            input("Enter your score (in degrees) for the trunk rotation test: "))
