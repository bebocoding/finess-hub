...
from ..opt_model.training_parameters import TrainingParameters


class FitnessPhase(ABC):
    def __init__(self):
        self.flexibility_training_parameters = TrainingParameters(muscle_groups=None, reps=None, sets=None, tempo=None, intensity=None,
                                                                  load=None, rest=None, schedule=None, frequency=None, volume=None, split=None, duration=None, exercise_selection=None)
        self.core_training_parameters = TrainingParameters(muscle_groups=None, reps=None, sets=None, tempo=None, intensity=None,
                                                           load=None, rest=None, schedule=None, frequency=None, volume=None, split=None, duration=None, exercise_selection=None)
        self.balance_training_parameters = TrainingParameters(muscle_groups=None, reps=None, sets=None, tempo=None, intensity=None,
                                                              load=None, rest=None, schedule=None, frequency=None, volume=None, split=None, duration=None, exercise_selection=None)
        self.plyometric_training_parameters = TrainingParameters(muscle_groups=None, reps=None, sets=None, tempo=None, intensity=None,
                                                                 load=None, rest=None, schedule=None, frequency=None, volume=None, split=None, duration=None, exercise_selection=None)
        self.saq_training_parameters = TrainingParameters(muscle_groups=None, reps=None, sets=None, tempo=None, intensity=None,
                                                          load=None, rest=None, schedule=None, frequency=None, volume=None, split=None, duration=None, exercise_selection=None)
        self.resistance_training_parameters = TrainingParameters(muscle_groups=None, reps=None, sets=None, tempo=None, intensity=None,
                                                                 load=None, rest=None, schedule=None, frequency=None, volume=None, split=None, duration=None, exercise_selection=None)
        self.progress_data = {}
        self.duration = None  # weeks
        self.intensity = None
        self.trainings = ["flexibility", "core",
                          "balance", "plyometric", "saq", "resistance"]
    ...
    def display_training_parameters(self, training_parameters):
        ...
        print(
            f"- Exercise Selection: {training_parameters.exercise_selection}")
    ...
    def display_summary(self):
        ...
        print(
            f"\t- Rest Interval: {self.training_parameters.rest_interval} seconds")
